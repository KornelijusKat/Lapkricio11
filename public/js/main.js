...
var WeatherApi = /*#__PURE__*/function () {
  function WeatherApi(term) {
    _classCallCheck(this, WeatherApi);
    this.term = term;
  }
  return _createClass(WeatherApi, [{
    key: "ajaxService",
    value: function ajaxService(term) {
      var key = 'fdf2b36efb14a784acff8e5979be8adc';
      var uri = "http://api.openweathermap.org/geo/1.0/direct?q=".concat(this.term, "&limit=5&appid=").concat(key);
...
var weather = new _api_WeatherApi__WEBPACK_IMPORTED_MODULE_0__["default"]('london');
